...
@interface Type4ViewControllerSecond ()
...
@implementation Type4ViewControllerSecond
...
- (void)viewDidLoad {
    ...
    TCNestScrollPageView *scrollPageView = [[TCNestScrollPageView alloc] initWithFrame:CGRectMake(0, naviHederH, SCREEN_WIDTH, SCREEN_HEIGHT - naviHederH) headView:self.nestPageScrollHeaderView viewPageView:viewPager nestScrollParam:nestScrollParam];
    ...
    scrollPageView.mainTabelView.mj_header = [MJRefreshNormalHeader headerWithRefreshingBlock:^{
        ...
        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
            ...
            if(self.headType == 1) {
                ...
                [self.nestPageScrollHeaderView resetFrame:CGRectMake(0, 0, SCREEN_WIDTH, headerHeight)];
                [scrollPageView resetHeader:self.nestPageScrollHeaderView];
                self.headType = 1;
            }
